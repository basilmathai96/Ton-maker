...
public class NewsFragment extends Fragment {
    ...
    DatabaseReference newsRef = database.getReference("News/Approved");
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ((MainActivity) getActivity()).getSupportActionBar().setTitle("Live News");

        mRecyclerView = (RecyclerView) view.findViewById(R.id.recycler_view);
        ((LinearLayout) view.findViewById(R.id.votesLayout)).setVisibility(View.GONE);
